...
sub RunContentTask(sectionName, sectionEndpoint)
    ' m.contentTask = invalid
    m.GridScreen.content = invalid ' clear GridScreen content while new content is loading
    ...
    m.contentTask.sectionName = sectionName ' pass section name to task
    m.contentTask.sectionEndpoint = sectionEndpoint ' pass section endpoint to task
